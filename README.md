IT371 – Linux Server Administration Project

Overview:

This project was completed as part of the IT371 – System Administration course.
...
The project consists of three main server services:
...
- Researching DNS concepts and planning the implementation.
- Preparing the Ubuntu environment for deployment.
- Installing and configuring the BIND9 DNS server.
- Configuring DNS forwarding and caching.
...
The attached project report includes:
...
For detailed implementation steps, configuration, testing, troubleshooting, and screenshots, please refer to the project report included in this repository.
